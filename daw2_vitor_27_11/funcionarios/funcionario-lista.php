...
<header >
	...
	<div class="menu">
		<nav>
		  ...
		  <a href="funcionario-cadastra.php"><div class="menu--link" > Cadastrar Funcionario</div></a>
...
<body>
	...
	<table dir="ltr" width="400px"  class="tg"
        ...
        <td><?php echo $agendamento->getNome(); ?></td>
...
">Editar</button>
<button type="button" onclick="confirm('Deseja exclir este registro?') ? window.location='funcionario-deleta-ok.php?id=<?php echo $funcionario->getId(); ?>' :
